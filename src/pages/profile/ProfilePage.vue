<template>
  <q-page padding>
    <section class="row q-col-gutter-x-xl q-py-lg">
      ...
      <div class="col-12 col-grow column justify-between">
        <div class="row items-center">
          <span class="text-h6 text-weight-bold">kkanghyungu</span>
          <q-space />
    ...
    <section class="q-mt-xl">
      <q-tabs v-model="tab" inline-label switch-indicator indicator-color="primary" class="q-mb-lg">
